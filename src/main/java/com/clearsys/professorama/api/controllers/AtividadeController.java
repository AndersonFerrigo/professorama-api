...
public class AtividadeController {
	...
	/*
	 * private Atividade converterDtoParaAtividade(CadastroAtividadeDto
	 * atividadeDto, BindingResult result) throws NoSuchAlgorithmException{
	 * 
	 * Atividade atividade = new Atividade();
	 * 
	 * atividade.setId(atividadeDto.getId());
	 ...
	 * atividade.setDataEntrega(atividadeDto.getDataEntrega());
	 * atividade.setDescricao(atividadeDto.getDescricao());
	 * atividade.getProfessor().getId(); return atividade;
	 * 
	 * }
	 */
